        ...
        <header>
            ...
            @if (Auth::check())
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" id="first_name" name="first_name" class="form-input"  placeholder="{{Auth::user()->FIRST_NAME}}">
                </div>
                <div class="input-wrapper">
                    <label for="name" class="form-label h5">Last Name</label>
                    <input type="text" id="last_name" name="last_name" class="form-input"  placeholder="{{Auth::user()->LAST_NAME}}">
                </div>
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" id="email" name="email" class="form-input"  placeholder="{{Auth::user()->ADDRESS}}">
                </div>

                <div class="input-wrapper">
                    <label for="phone_num" class="form-label h5">PHONE NUMBER</label>
                    <input type="text" id="phone_num" name="phone_num" class="form-input"  placeholder="{{Auth::user()->PHONE_NUM}}">
                </div>
                <div class="input-wrapper">
                    <label for="bio" class="form-label h5">BIO</label>
                    <input type="text" id="bio" name="bio" class="form-input"  placeholder="{{Auth::user()->BIO}}">
                </div>
                <div class="input-wrapper">
                    <label for="job_title" class="form-label h5">JOB_TITLE</label>
                    <input type="text" id="job_title" name="job_title" class="form-input"  placeholder="{{Auth::user()->JOB_TITLE}}">
                </div>
                <div class="input-wrapper">
                    <label for="birthday" class="form-label h5">BIRTHDAY</label>
                    <input type="date" id="birthday" name="birthday" class="form-input"  placeholder="{{Auth::user()->BIRTHDAY}}">
                </div>
                <div class="input-wrapper">
                    <label for="github" class="form-label h5">GITHUB</label>
                    <input type="url" id="github" name="github" class="form-input"  placeholder="{{Auth::user()->GITHUB_URL}}">
                </div>
                <div class="input-wrapper">
                    <label for="linked_in" class="form-label h5">LINKEDIN</label>
                    <input type="url" id="linked_in" name="linked_in" class="form-input"  placeholder="{{Auth::user()->LINKEDIN_URL}}">
                </div>
                <div class="input-wrapper">
                    <label for="instagram" class="form-label h5">INSTAGRAM</label>
                    <input type="url" id="instagram" name="instagram" class="form-input"  placeholder="{{Auth::user()->INSTAGRAM_URL}}">
                </div>
