            ...
            <ul class="contacts-list">
                ...
                <li class="contact-item">
                    ...
                    <div class="contact-info">
                        ...
                        <!-- 메일주소-->
                        <a href="mailto:메일주소" class="contact-link">developer.jiheuilee<br>@gmail.com</a>
                    </div>
                ...
                <li class="contact-item">
                    ...
                    <div class="contact-info">
                        ...
                        <!-- 전화번호-->
                        <a href="tel:+12133522795" class="contact-link">+82 (000) 000-0000</a>
                    </div>
                ...
                <li class="contact-item">
                    ...
                    <div class="contact-info">
                        ...
                        <!-- 생일-->
                        <time datetime="1991-07-22">July 00, 0000</time>
                    </div>
    ...
    <div class="main-content">
        ...
        <nav class="navbar">
            ...
            <ul class="navbar-list">
                ...
                <li class="navbar-item">
                    <button class="navbar-link" data-nav-link>Bio</button>
                </li>
        ...
        <article class="bio" data-page="bio">
        ...
        <!--
          - #BLOG (쓰고싶은 내용을 static으로 하거나 지워도 되요! - 데이터베이스 넣어서 하실분은 물어보세요)
        -->
